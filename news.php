        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-7 col-sm-7 ">
                    ...
                    <div class="col-xs-12 col-md-12 col-sm-12 news-list"> 
                        <h3 align="center"><span class="heading">Latest News</span></h3>  
                        <ul>
                        <br/>
                        <?php getIndexNews(); ?>
                       </ul>     
                ...
                <div class="col-xs-12 col-md-4 col-sm-4 " >
                    ...
                    <div class="col-xs-12 col-md-12 col-sm-12 recent-news">
                        <div class="input-group">
                         <!--  <form action="_cpanel/search.php" method="post"> -->
                            <input type="text" name="search-value" class="form-control" placeholder="Search">
                            <div class="input-group-btn">
                            <!-- </form> -->
                            <button name="search" class="btn btn-default"><i class="glyphicon glyphicon-search"></i></button>
